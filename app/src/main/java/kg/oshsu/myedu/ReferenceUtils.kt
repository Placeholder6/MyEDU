...
class ReferencePdfGenerator(private val context: Context) {
    ...
    suspend fun generatePdf(
        ...
        // STEP 1: Heavy String Construction (Off Main Thread)
        val htmlContent = withContext(Dispatchers.Default) {
            ...
            if (match != null) {
                ...
                if (startIndex != -1 && endIndex != -1) {
                    ...
                    throw Exception("Could not extract PDF logic from script.")
                }
            }
        ...
        // STEP 2: Main Thread - Only WebView Creation
        return suspendCancellableCoroutine { continuation ->
            Handler(Looper.getMainLooper()).post {
                try {
                    ...
                    // Load the pre-built HTML content
