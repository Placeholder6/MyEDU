...
interface OshSuApi {
    ...
    // 4. Generate PDF (Sends JSON data so server generates it)
    @Multipart
    ...
    suspend fun generateTranscript(
        ...
        @Part("contents") contents: RequestBody, // <--- JSON string sent as text
