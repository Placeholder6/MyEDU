...
interface OshSuApi {
    ...
    // 4. Upload the PDF generated by our JS Engine
    // This mimics the browser exactly: ID, StudentID, and the PDF File.
    // We DO NOT send 'contents' here because we are providing a valid PDF file.
    @Multipart
...
class DebugCookieJar : CookieJar {
    ...
    fun setDebugCookies(token: String) {
        ...
        // 2. Timestamp (Mimics browser session)
...
// --- INTERCEPTOR (Dynamic Referer) ---
class DebugInterceptor : Interceptor {
    var authToken: String? = null
    // Mutable Referer: Allows MainActivity to update this per-step (Required for Step 4)
